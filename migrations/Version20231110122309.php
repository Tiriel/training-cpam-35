 ...
 */
final class Version20231110122309 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        , plot CLOB NOT NULL, price INTEGER DEFAULT NULL, imdb_id VARCHAR(25) DEFAULT NULL, rated VARCHAR(15) DEFAULT NULL, CONSTRAINT FK_1D5EF26FB03A8386 FOREIGN KEY (created_by_id) REFERENCES user (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
